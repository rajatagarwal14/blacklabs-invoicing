...
interface Props<T, TAdd, TUpdate> {
  ...
  /**
   * Initial sort direction. SortType.DEFAULT means "do not sort client-side",
   * which leaves the backend's id-ascending order — oldest first. Pages where
   * recent activity is the point should pass DESC.
   */
