  ...
  return (
    <>
      <CRUDPage<Invoice, InvoiceAdd, InvoiceUpdate>
        ...
        // Most recently issued first. An invoicing app should open on current
        // activity; sorting by status surfaces the oldest settled invoices,
        // which is the least interesting thing on the screen.
